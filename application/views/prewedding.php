            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Prewedding Shoot</h2>
                ...
                <div class="row alime-portfolio">
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country  wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr1.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr1.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country  wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr2.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr2.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country  wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr3.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr3.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr4.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr4.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country  wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr5.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr5.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 single_gallery_item video country wow fadeInUp" data-wow-delay="100ms" style="padding:5px;box-shadow: 0 2px 10px 0 grey;">
                        <div class="single-portfolio-content">
                            <img src="<?php echo $url;?>img/bg-img/pr6.jpg" alt="">
                            <div class="hover-content">
                                <a href="<?php echo $url;?>img/bg-img/pr6.jpg" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
