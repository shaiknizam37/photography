...
<head>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            <!-- Single Slide -->
            <div class="single-welcome-slide bg-img" style="height: 600px;background-image: url(img/bg-img/2.jpg);">
            ...
            <!-- Single Slide -->
            <div class="single-welcome-slide bg-img" style="height: 600px;background-image: url(img/bg-img/1.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12 col-lg-8 col-xl-6">
            ...
            <!--Single Slide-->
            <div class="single-welcome-slide bg-img" style="height: 600px;background-image: url(img/bg-img/2a.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12 col-lg-8 col-xl-6">
            ...
            <!--Single Slide-->
            <div class="single-welcome-slide bg-img" style="height: 600px;background-image: url(img/bg-img/2b.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12 col-lg-8 col-xl-6">
